defmodule Library.Repo.Migrations.InstallAshMoneyV420240806172944 do
  @moduledoc """
  ...
  def down do
    ...
    execute "DROP FUNCTION IF EXISTS money_gt(money_1 money_with_currency, money_2 money_with_currency);"

    execute "DROP FUNCTION IF EXISTS money_gt(money_1 money_with_currency, amount numeric);"
    execute "DROP OPERATOR >=(money_with_currency, money_with_currency);"
    execute "DROP OPERATOR >=(money_with_currency, numeric);"

    execute "DROP FUNCTION IF EXISTS money_gte(money_1 money_with_currency, money_2 money_with_currency);"

    execute "DROP FUNCTION IF EXISTS money_gte(money_1 money_with_currency, amount numeric);"
    execute "DROP OPERATOR <(money_with_currency, money_with_currency);"
    execute "DROP OPERATOR <(money_with_currency, numeric);"

    execute "DROP FUNCTION IF EXISTS money_lt(money_1 money_with_currency, money_2 money_with_currency);"

    execute "DROP FUNCTION IF EXISTS money_lt(money_1 money_with_currency, amount numeric);"
    execute "DROP OPERATOR <=(money_with_currency, money_with_currency);"
    execute "DROP OPERATOR <=(money_with_currency, numeric);"

    execute "DROP FUNCTION IF EXISTS money_lte(money_1 money_with_currency, money_2 money_with_currency);"

    execute "DROP FUNCTION IF EXISTS money_lte(money_1 money_with_currency, amount numeric);"
    execute "DROP OPERATOR - (money_with_currency, money_with_currency);"

    execute "DROP FUNCTION IF EXISTS money_sub(money_1 money_with_currency, money_2 money_with_currency);"
